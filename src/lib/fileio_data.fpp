...
module fileio_data_mod
  ...
  public  :: write_data_real_array
  public  :: write_data_real
  public  :: write_data_real8_array
  public  :: write_data_real8
  public  :: write_data_real4_array
  public  :: write_data_real4
  ...
  public  :: read_data_real_array
  public  :: read_data_real
  public  :: read_data_real8_array
  public  :: read_data_real8
  public  :: read_data_real4_array
  public  :: read_data_real4
...
contains
  ...
  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    write_data_real_array
  ...
  subroutine write_data_real_array(handle, tag, dsize, data)
  ...
  end subroutine write_data_real_array

  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    write_data_real
  ...
  subroutine write_data_real(handle, tag, data)
  ...
  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    write_data_real8_array
  ...
  subroutine write_data_real8_array(handle, tag, dsize, data)
  ...
  end subroutine write_data_real8_array

  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    write_data_real8
  ...
  subroutine write_data_real8(handle, tag, data)
  ...
  end subroutine write_data_real8

  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    write_data_real4_array
  ...
  subroutine write_data_real4_array(handle, tag, dsize, data)
  ...
  end subroutine write_data_real4_array

  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    write_data_real4
  ...
  subroutine write_data_real4(handle, tag, data)
  ...
  end subroutine write_data_real4
  ...
  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    read_data_real_array
  ...
  subroutine read_data_real_array(handle, tag, dsize, data, oerr_stop)
  ...
  end subroutine read_data_real_array

  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    read_data_real
  ...
  subroutine read_data_real(handle, tag, data, oerr_stop)
  ...
  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    read_data_real8_array
  ...
  subroutine read_data_real8_array(handle, tag, dsize, data, oerr_stop)
    ...
    if (no_tag) then
      msg = 'Read_Data_Real8_Array> indicated tag is not found at file.['// &
           trim(tag)//']'
      if (err_stop) call error_msg(msg)
      if (main_rank) write(MsgOut,'(a,/)') trim(msg)//'  skip..'
      return
  ...
  end subroutine read_data_real8_array

  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    read_data_real8
  ...
  subroutine read_data_real8(handle, tag, data, oerr_stop)
    ...
    if (no_tag) then
      msg = 'Read_Data_Real8> indicated tag is not found at file.['// &
           trim(tag)//']'
      if (err_stop) call error_msg(msg)
      if (main_rank) write(MsgOut,'(a,/)') trim(msg)//'  skip..'
      return
  ...
  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    read_data_real4_array
  ...
  subroutine read_data_real4_array(handle, tag, dsize, data, oerr_stop)
    ...
    if (no_tag) then
      msg = 'Read_Data_Real4_Array> indicated tag is not found at file.['// &
           trim(tag)//']'
      if (err_stop) call error_msg(msg)
      if (main_rank) write(MsgOut,'(a,/)') trim(msg)//'  skip..'
      return
  ...
  end subroutine read_data_real4_array

  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    read_data_real4
  ...
  subroutine read_data_real4(handle, tag, data, oerr_stop)
    ...
    if (no_tag) then
      msg = 'Read_Data_Real4> indicated tag is not found at file.['// &
           trim(tag)//']'
      if (err_stop) call error_msg(msg)
      if (main_rank) write(MsgOut,'(a,/)') trim(msg)//'  skip..'
      return
