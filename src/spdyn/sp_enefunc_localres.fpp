...
contains
  ...
  subroutine setup_enefunc_localres_bond(localres, domain, enefunc)
    ...
    ! local variable
    integer                   :: i, ig, k, ix, iatm, icel_local, i1, i2
    ...
    integer,          pointer :: bond(:), list(:,:,:), cell_pair(:,:)
    integer,          pointer :: bkind(:,:)
  ...
  subroutine setup_enefunc_localres_angle(localres, domain, enefunc)
    ...
    ! local variable
    integer                   :: i, ig, k, ix, iatm, icel_local
    integer                   :: i1, i2, i3
    ...
    integer,          pointer :: index_atoms(:,:)
    integer,          pointer :: func(:)
    integer,          pointer :: angle(:), list(:,:,:), cell_pair(:,:)
    integer,          pointer :: akind(:,:)
  ...
  subroutine setup_enefunc_localres_dihed(localres, domain, enefunc)
    ...
    integer,          pointer :: index_atoms(:,:)
    integer,          pointer :: func(:)
    integer,          pointer :: dihed(:), list(:,:,:), cell_pair(:,:)
